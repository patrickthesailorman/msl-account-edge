...
public class LibraryServiceTest {
  ...
  public void getLibrary() throws Exception {
    ...
    assertEquals(myLibrary.getAlbums().get(0).getAlbumId(), tc.ALBUMS_BY_USER_DTO.getAlbumId()
        .toString());
    assertEquals(myLibrary.getAlbums().get(0).getAlbumName(), tc.ALBUMS_BY_USER_DTO.getAlbumName());
    assertEquals(myLibrary.getAlbums().get(0).getArtistId(), tc.ALBUMS_BY_USER_DTO.getArtistId()
        .toString());
    assertEquals(myLibrary.getAlbums().get(0).getArtistName(),
        tc.ALBUMS_BY_USER_DTO.getArtistName());

    assertEquals(myLibrary.getArtists().size(), 1);
    assertEquals(myLibrary.getArtists().get(0).getArtistName(),
        tc.ARTISTS_BY_USER_DTO.getArtistName());
    assertEquals(myLibrary.getArtists().get(0).getArtistId(), tc.ARTISTS_BY_USER_DTO.getArtistId()
        .toString());

    assertEquals(myLibrary.getSongs().size(), 1);
    assertEquals(myLibrary.getSongs().get(0).getSongName(), tc.SONGS_BY_USER_DTO.getSongName());
    assertEquals(myLibrary.getSongs().get(0).getSongId(), tc.SONGS_BY_USER_DTO.getSongId()
        .toString());
    assertEquals(myLibrary.getSongs().get(0).getArtistName(), tc.SONGS_BY_USER_DTO.getArtistName());
    assertEquals(myLibrary.getSongs().get(0).getArtistId(), tc.SONGS_BY_USER_DTO.getArtistId()
        .toString());
    assertEquals(myLibrary.getSongs().get(0).getAlbumName(), tc.SONGS_BY_USER_DTO.getAlbumName());
    assertEquals(myLibrary.getSongs().get(0).getAlbumId(), tc.SONGS_BY_USER_DTO.getAlbumId()
        .toString());
  }
  ...
  public void testAddArtist() throws Exception {
    ...
    expect(cassandraAccountService.addOrUpdateArtistsByUser(EasyMock.anyObject())).andThrow(
  ...
  @Test(expected = RuntimeException.class)
  public void testAddArtistGetEmptyArtistException() throws Exception {
    // Mock get MyLibrary Expectations
    mockRatingsHelper();
    getMyLibraryAlbumsExpectations();
    getMyLibraryArtistsExpectations();
  ...
  @Test(expected = RuntimeException.class)
  public void testAddAlbumGetEmptyAlbumException() throws Exception {
    // Mock get MyLibrary Expectations
    mockRatingsHelper();
    getMyLibraryAlbumsExpectations();
    getMyLibraryArtistsExpectations();
  ...
  @Test(expected = RuntimeException.class)
  public void testAddSongGetEmptySongException() throws Exception {
    // Mock get MyLibrary Expectations
    mockRatingsHelper();
    getMyLibraryAlbumsExpectations();
    getMyLibraryArtistsExpectations();
  ...
  public void testAddAlbum() throws Exception {
    ...
    expect(cassandraAccountService.addOrUpdateAlbumsByUser(EasyMock.anyObject())).andThrow(
        new RuntimeException());
  ...
  public void testAddSong() throws Exception {
    ...
    expect(cassandraAccountService.addOrUpdateSongsByUser(EasyMock.anyObject())).andThrow(
        new RuntimeException());
  ...
  public void testRemoveArtist() throws Exception {
    getMyLibraryArtistsExpectations();
    expect(
        cassandraAccountService.deleteArtistsByUser(tc.USER_ID, tc.FAVORITES_TIMESTAMP,
            tc.ARTIST_UUID)).andReturn(null);
    getMyLibraryArtistsExpectations();
    replay(cassandraAccountService);
    PowerMock.replayAll();
    ...
    LibraryService ls = new LibraryService();
    ls.remove(cassandraAccountService, tc.ARTIST_UUID.toString(),
        String.valueOf(tc.FAVORITES_TIMESTAMP.getTime()), tc.USER_ID.toString(), "Artist");
  }
  ...
  public void testRemoveAlbum() throws Exception {
    getMyLibraryAlbumsExpectations();
    expect(
        cassandraAccountService.deleteAlbumsByUser(tc.USER_ID, tc.FAVORITES_TIMESTAMP,
            tc.ALBUM_UUID)).andReturn(null);
    getMyLibraryAlbumsExpectations();
    replay(cassandraAccountService);
    PowerMock.replayAll();
    ...
    LibraryService ls = new LibraryService();
    ls.remove(cassandraAccountService, tc.ALBUM_UUID.toString(),
        String.valueOf(tc.FAVORITES_TIMESTAMP.getTime()), tc.USER_ID.toString(), "Album");
  }
  ...
  public void testRemoveSong() throws Exception {
    getMyLibrarySongsExpectations();
    expect(
        cassandraAccountService.deleteSongsByUser(tc.USER_ID, tc.FAVORITES_TIMESTAMP, tc.SONG_UUID))
        .andReturn(null);
    getMyLibrarySongsExpectations();
    replay(cassandraAccountService);
    PowerMock.replayAll();
    ...
    LibraryService ls = new LibraryService();
    ls.remove(cassandraAccountService, tc.SONG_UUID.toString(),
        String.valueOf(tc.FAVORITES_TIMESTAMP.getTime()), tc.USER_ID.toString(), "Song");
  }
  ...
  private void mockCassandraCatalogService() throws Exception {
  ...
  private void mockLibraryServiceHelperGetArtist() throws Exception {
  ...
  private void mockLibraryServiceHelperGetAlbum() throws Exception {
    mockCassandraCatalogService();
  ...
  private void mockLibraryServiceHelperGetSong() throws Exception {
    mockCassandraCatalogService();
  ...
  private void mockLibraryServiceHelperGetNullArtist() throws Exception {
    mockCassandraCatalogService();
  ...
  private void mockLibraryServiceHelperGetNullAlbum() throws Exception {
    mockCassandraCatalogService();
  ...
  private void mockLibraryServiceHelperGetNullSong() throws Exception {
    mockCassandraCatalogService();
