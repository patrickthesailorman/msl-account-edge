...
public class LibraryClient {
  ...
  public AccountEdgeApiResponseMessage getLibrary(String sessionToken) {
    ...
    ResteasyWebTarget target =
        client.target(String.format("%s/account-edge/users/mylibrary",
  ...
  public AccountEdgeApiResponseMessage addAlbumToLibrary(String albumId, String sessionToken) {
    ResteasyWebTarget target =
        client.target(String.format("%s/account-edge/users/mylibrary/addalbum/%s",
  ...
  public AccountEdgeApiResponseMessage addArtistToLibrary(String artistId, String sessionToken) {
    ResteasyWebTarget target =
        client.target(String.format("%s/account-edge/users/mylibrary/addartist/%s",
   ...
   * @return AccountEdgeApiResponseMessage
   */
  public AccountEdgeApiResponseMessage removeArtistFromLibrary(String artistId, String timestamp,
      String sessionToken) {
    ResteasyWebTarget target =
        client.target(String.format("%s/account-edge/users/mylibrary/removeartist/%s/%s",
            ClientConstants.getInstance().BASE_URL, artistId, timestamp));
