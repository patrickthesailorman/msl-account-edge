...
public class LibraryService extends LibraryServiceHelper {
     ...
     * @param inputTimestamp timestamp set on REST endpoint as String
        ...
        switch ( contentType ) {
            case "Song":
                try {
                    ...
                    cassandraAccountService.deleteSongsByUser(UUID.fromString(sessionToken), inputTimestamp,
                                                              UUID.fromString(id));
            ...
            case "Artist":
                try {
                    ...
                    cassandraAccountService.deleteArtistsByUser(UUID.fromString(sessionToken), inputTimestamp,
                                                                UUID.fromString(id));
            ...
            case "Album":
                try {
                    ...
                    cassandraAccountService.deleteAlbumsByUser(UUID.fromString(sessionToken), inputTimestamp,
                                                               UUID.fromString(id));
