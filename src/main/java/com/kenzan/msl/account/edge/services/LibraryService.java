...
public class LibraryService extends LibraryServiceHelper {
     ...
     * @return MyLibrary
     */
    public MyLibrary get(final CassandraAccountService cassandraAccountService, final String sessionToken) {
     ...
     */
    public void add(final CassandraAccountService cassandraAccountService, final String id, final String sessionToken,
     ...
     */
    public void remove(final CassandraAccountService cassandraAccountService, final String id, final String timestamp,
        ...
        switch ( contentType ) {
            case "Song":
                try {
                    int initialSongsOnLibrary = getMyLibrarySongs(cassandraAccountService, sessionToken).size();
                    cassandraAccountService.deleteSongsByUser(UUID.fromString(sessionToken), favoritesTimestamp,
                                                              UUID.fromString(id));
            ...
            case "Artist":
                try {
                    int initialArtistsOnLibrary = getMyLibraryArtists(cassandraAccountService, sessionToken).size();
                    cassandraAccountService.deleteArtistsByUser(UUID.fromString(sessionToken), favoritesTimestamp,
                                                                UUID.fromString(id));
                    int postArtistsOnLibrary = getMyLibraryArtists(cassandraAccountService, sessionToken).size();
            ...
            case "Album":
                try {
                    int initialAlbumsOnLibrary = getMyLibraryAlbums(cassandraAccountService, sessionToken).size();
                    cassandraAccountService.deleteAlbumsByUser(UUID.fromString(sessionToken), favoritesTimestamp,
                                                               UUID.fromString(id));
                    int postAlbumsOnLibrary = getMyLibraryAlbums(cassandraAccountService, sessionToken).size();
