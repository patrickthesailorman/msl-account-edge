...
public class AccountEdgeSessionTokenImpl implements AccountEdgeSessionToken {
    ...
    /**
     * Returns the sessionToken in a cookie format, if a sessionToken is passed it updates the AccountEdgeSessionTokenImpl value with it
     *
     * @param sessionToken value to update AccountEdgeSessionTokenImpl.value with
     * @return NewCookie
     */
